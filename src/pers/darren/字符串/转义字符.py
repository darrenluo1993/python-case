...
print(decimal_number, '转换为二进制:', binary_number)  # 转换为二进制: 0b101010

octal_number = oct(decimal_number)  # 十进制转换为八进制
print(decimal_number, '转换为八进制:', octal_number)  # 转换为八进制: 0o52

hexadecimal_number = hex(decimal_number)  # 十进制转换为十六进制
print(decimal_number, '转换为十六进制:', hexadecimal_number) # 转换为十六进制: 0x2a